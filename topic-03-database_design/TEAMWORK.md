...
| Andrii Maidabura | Reviews, Testing & Documentation | Reviews and ratings, testing, documentation, presentation preparation | `reviews`, project documentation |
...
- **Zhyryk Vitaliy** відповідав за систему інвентаризації фізичних екземплярів книг (`book_copies`), логіку доступності книг та відстеження статусів екземплярів.
...
- **Andrii Maidabura** відповідав за систему відгуків і рейтингів (`reviews`), тестування, документацію та підготовку матеріалів для презентації проєкту.
